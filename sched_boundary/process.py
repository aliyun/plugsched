...
def lookup_if_global(name, file):
    ...
    return global_fn_dict.get(name, None) if file == '?' else file
...
if __name__ == '__main__':
    ...
    for meta in metas:
        for name, file in meta['fn_ptr']:
            if file in config['mod_files'] and (name, file) not in fn_symbol_classify['interface']:
                fn_symbol_classify['fn_ptr'].add((name, lookup_if_global(name, file)))
